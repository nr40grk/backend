...
router.post('/', (req, res) => {
  uploadBookingFiles(req, res, async (err) => {
    ...
    try {
      const { fullName, phone, email, artist, service, message, piercingType, depositAmount, paymentIntentId } = req.body;
      ...
      const booking = new Booking({
        ...
        ...(isPiercing && {
          ...
          depositAmount: 12.50,
          depositPaid: true, // paid before booking is submitted
        }),
      });
